...
// /**
//  * 작업계획 API 클라이언트 - 프론트엔드 AJAX 호출용
//  */
// const WorkLogApi = {
//   /**
//    * 작업계획 목록 조회 (필터링 및 페이징)
//    * @param {Object} params - 쿼리 매개변수
//    * @returns {Promise<Object>} 작업계획 목록 및 페이징 정보
//    */
...
//     if (!response.ok) {
//       throw new Error(`작업계획 목록 조회 실패: ${response.statusText}`);
//     }
...
//    * @returns {Promise<Object>} 작업계획 상세 정보
//    */
//   getWorkLog: async (id) => {
//     const response = await fetch(`/api/worklogs/${id}`);
//     if (!response.ok) {
//       throw new Error(`작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
//   /**
//    * 새 작업계획 생성
//    * @param {Object} workLog - 작업계획 데이터
//    * @returns {Promise<Object>} 생성된 작업계획 ID
//    */
...
//
//     if (!response.ok) {
//       throw new Error(`작업계획 생성 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//    * 기존 작업계획 업데이트
//    * @param {number} id - 작업계획 ID
//    * @param {Object} workLog - 업데이트할 작업계획 데이터
...
//
//     if (!response.ok) {
//       throw new Error(`작업계획 업데이트 실패: ${response.statusText}`);
//     }
//   },
//
//   /**
...
//
//     if (!response.ok) {
//       throw new Error(`작업계획 삭제 실패: ${response.statusText}`);
//     }
//   },
//
//   /**
...
//     if (!response.ok) {
//       throw new Error(`날짜 범위로 작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//     if (!response.ok) {
//       throw new Error(`차량 모델로 작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//     if (!response.ok) {
//       throw new Error(`제품 코드로 작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//     if (!response.ok) {
//       throw new Error(`상태별 작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//     if (!response.ok) {
//       throw new Error(`사용자별 작업계획 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   },
//
...
//    * 작업계획 통계 데이터 조회
//    * @param {Object} params - 쿼리 매개변수
//    * @returns {Promise<Object>} 작업계획 통계 데이터
//    */
...
//     if (!response.ok) {
//       throw new Error(`작업계획 통계 조회 실패: ${response.statusText}`);
//     }
//     return response.json();
//   }
// };
